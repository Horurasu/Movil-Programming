...
export class ExtraPage implements OnInit {
  ...
  loadExtras(){
    ...
    this.http.get<any>('http://localhost/ACTIVIDAD_EXAMEN_7_TERM/actividad_examen_BEM/back_end_moviles/tablas/api/Extra')
    .subscribe(response => {
      ...
      buttons: [
        {
          ...
          handler : (data) => {
            ...
            console.log(data);
            this.http.post<any>(
              "http://localhost/ACTIVIDAD_EXAMEN_7_TERM/actividad_examen_BEM/back_end_moviles/tablas/api/Extra",
              data
            ).subscribe(response => {
      ...
      buttons: [
        {
          ...
          handler : (data) => {
            ...
            console.log(data);
            this.http.put<any>(
              "http://localhost/ACTIVIDAD_EXAMEN_7_TERM/actividad_examen_BEM/back_end_moviles/tablas/api/Extra/id/"+extra.id,
              data
            ).subscribe(response => {
  ...
  async mostrar_extra(extra){
    const alert = await this.alertController.create({
      header : "Description",
      message: extra.descripcion,
      buttons: [
